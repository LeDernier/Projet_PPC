...
module TestColoring
    ...
    path = "..\\..\\External instances\\instances_coloring\\random-70.col"
    ...
    status, sol_time, sizeTree = solve(instance, Inf, true, true, false, false)         # applyBacktrack, applyMACR, applyFC, applyMAC
